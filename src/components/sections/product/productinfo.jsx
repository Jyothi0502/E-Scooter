import productinfo from "/src/assets/images/productinfo.svg";
  ...
  return (
    <div className="m-10 mt-30 flex flex-col text-clr">
      ...
      <div className="flex flex-col lg:flex-row gap-28 mt-8 mb-15">
        <img src={productinfo}className="w-175 -mb-15  self-start lg:self-auto" alt="Product" width="300" 
        />
        <img src={features} className="w-xs mb-0 lg:mb-0 mx-auto lg:ml-10 lg:w-sm" alt="Features" width="300" />
      </div>
    </div>
  );
};
