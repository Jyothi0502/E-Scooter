    ...
    return (
      <div className="flex flex-col lg:flex-row items-center justify-between mt-0 text-clr px-10">
        <div className="lg:w-1/2">
          ...
          <img src="dicider.svg" className="mt-20 lg:mt-28" alt="dicider" />
          ...
          <div className="flex items-center gap-28 mt-6">
            <div className="flex items-center gap-2 cursor-pointer">
              <img src="icon.svg" className="arrow" alt="arrow" width={40} />
            ...
            <div className="flex items-center cursor-pointer">
              ...
              <img src="play button.svg" className="play" alt="play" />
            </div>
          </div>
        </div>
        <div className="lg:w-1/2 flex flex-col items-center lg:items-end gap-3 order-last lg:order-none lg:ml-10">
          <img src="vehicle.svg" alt="vehicle" className="w-5/6 mt-6 lg:mt-4 lg:w-xl lg:mr-10" />
          <div className="flex gap-8 mt-0 lg:-mt-5 mr-10">
            <img src="01.svg" alt="number" width={80} />
            <img src="arrows.svg" alt="double-arrow" width={80} />
          </div>
        </div>
      </div>
    );
